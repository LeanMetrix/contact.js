window.render = {};render["button"] = function anonymous(data) {
var out='<div id="contact-btn">'+(data.buttonText)+'</div>';return out;
};
render["modal"] = function anonymous(data) {
